...
public class DFSOdamRaw {
    ...
    public DFSOdamRaw() {
        this.type = -1;
        this.data = new float[Config_Odam.MAX_FCT_CNT];
        this.timeStamp = -1l;
    }
     ...
     * @param ts
     */
    public DFSOdamRaw(int type, byte[] bin, long ts){
        super();
        ...
        for(int i = 0 ; i < blength ; i+=4){
            ...
            //!!!System.out.println(this.getClass().getName()+".DFSOdamRaw() data["+((int)(i/4))+"] : " + (data[(int)(i/4)]) + " ############# \n ");
